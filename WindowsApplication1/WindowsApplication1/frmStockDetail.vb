...
Public Class frmStockDetail
    ...
    Public Function GetData() As DataView
        Dim SelectQry = "SELECT (ProductId) as [PRODUCT ID],(product) as [PRODUCT NAME],(ProductPrice) as [PRODUCT PRICE],(ProductQuantity) as [PRODUCT QUANTITY] FROM stock"
    ...
    Private Sub frmStockDetail_FormClosing(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles MyBase.FormClosing
        frmStock.Show()
    End Sub
End Class